...
export const metadata: Metadata = {
  ...
  keywords: 'exhibition stand builder UAE, exhibition stand designer Dubai, trade show displays, event solutions, exhibition contractor',
  ...
  twitter: {
    ...
    title: 'Messe.ae - Exhibition Stand Builder & Designer in UAE',
    description: 'Leading exhibition stand builder and designer in UAE. 20+ years of expertise in creating innovative exhibition solutions.',
